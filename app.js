...
//  var x = x.toLowerCase();
//  console.log(x);
// 3. Convert string y to upper-case and assign to the same variable
// y = y.toUpperCase();

// // 4. Convert string represented by a variable to lower-case and assign to a new variable
// var newVariable = yourVariable.toLowerCase();

// // 5. Convert string represented by an array element to lower-case and assign to a new variable
// var newArrayElement = yourArray[index].toLowerCase();

// // 6. Display in an alert the upper-case version of a variable's string
// alert(yourVariable.toUpperCase());

// // 7. Convert string cityName to Capitalisation
// var cityName = "kaRacHi";
// cityName = cityName.charAt(0).toUpperCase() + cityName.slice(1).toLowerCase();
// .............................chapterno22-25.........................................................
// var sameWords = "captain";
// var sliced = sameWords.slice(1, 3); // sliced = "ap"
// var numCharacters = sameWords.length; // numCharacters will hold the number of characters in the string
// var animal = "elephant";
// var middleIndex = Math.floor(animal.length / 2);
// var seg = animal.slice(middleIndex - 2, middleIndex + 2); // seg will hold the four middle characters
// var variable = "some string";
// var characterCount = variable.length; // characterCount will hold the number of characters in 'variable'
// var str = "some string";
// var charCount = str.length;
// var slicedString = str.slice(1, -3); // slicedString will have the characters except the first and last 3
// var text = "To be or not to be.";
// var indx = text.indexOf("be"); // indx = 3
// var text = "To be or not to be.";
// var indx = text.lastIndexOf("be"); // indx = 16
// var text = "Some text containing go.";
// var lastGoIndex = text.lastIndexOf("go");
// var indx = text.indexOf("go", lastGoIndex);
// if (str[indexNum] !== undefined) { /* code */ }
// var charAtIndex2 = "abcde".charAt(2); // charAtIndex2 = "c"
// var cha = text.charAt(9); // the 10th character in 'text'
// var x = str.charAt(str.length - 1); // last character in 'str'
// var cha = input.charAt(4); // the 5th character in 'input'
// if (variable.charAt(2) === 'specificCharacter') { /* code */ }
// var array = [];
// for (var i = 0; i < str.length; i++) {
//     array[i] = str.charAt(i);
// }
// var newStr = str.replace("1", "one"); // replace first instance of "1" with "one"
// var y = x.replace(/a/g, "z");
// .............................chapterno26.........................................................
// var roundedNumber = Math.round(yourNumber);
// var origNum = 5.2; // Example number
// var roundNum = Math.ceil(origNum);
// var origNum = 5.8; // Example number
// var roundNum = Math.floor(origNum);
// var numToRound = 7.6; // Example number
// var roundedVar = Math.round(numToRound);
// var roundedNum = Math.round(0.5); // Result will be 0

// .............................chapterno27.........................................................
// var randomNumber = Math.floor(Math.random() * 50) + 1;
// var randomNum = Math.random(); // This will generate a random number between 0 and 1
// // A standard six-sided dice
// var diceRoll = Math.floor(Math.random() * 6) + 1; // This will give a number between 1 and 6
...
// var integer = parseInt(decimalString); // This will result in integer = 3
// .............................chapterno30.........................................................
// var num = 10.123456789; // Example number
// var newNum = num.toFixed(4).toString();
// var variable = 7.891234; // Example number
// variable = parseFloat(variable.toFixed(2).toString());
// var num = 123.4567; // Example number
// if (num.toFixed(2).toString().length > 4) {
//     // Code if the condition is true
// }
// var number = 123.456789; // Example number
